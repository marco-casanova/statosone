...
import { ArrowLeft, Box, ShoppingCart, Truck, Info } from "lucide-react";
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div>
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            {modelUrl ? (
              <ModelViewer url={modelUrl} fileType={model.file_type} />
            ) : (
              <div className="model-viewer flex items-center justify-center">
          ...
          {priceBreakdown && (
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-6 text-white">
              ...
              <button
                onClick={handleOrder}
                disabled={ordering}
                className="w-full mt-6 py-3 bg-forge-500 hover:bg-forge-600 rounded-lg font-semibold flex items-center justify-center gap-2 transition-colors"
              >
                {ordering ? (
                  <div className="spinner" />
                ) : (
